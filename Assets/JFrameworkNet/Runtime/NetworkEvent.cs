...
namespace JFramework.Net
{
    internal static class NetworkEvent
    {
        ...
        /// 注册网络消息
        /// </summary>
        public static void RegisterMessage<T>(Action<ClientConnection, T> handle, bool isAuthority = true) where T : struct, NetworkMessage
        {
        ...
        /// 注册网络消息
        /// </summary>
        public static void RegisterMessage<T>(Action<ClientConnection, T, Channel> handle, bool isAuthority = true) where T : struct, NetworkMessage
        {
            serverEvents[MessageId<T>.Id] = NetworkUtils.Register(handle, isAuthority);
        }
        ...
        /// 客户端消息事件
        /// </summary>
        public static bool ClientMessage(ushort key, ServerConnection server, NetworkReader reader, Channel channel)
        {
        ...
        /// 服务器消息事件
        /// </summary>
        public static bool ServerMessage(ushort key, ClientConnection client, NetworkReader reader, Channel channel)
        {
