...
namespace JFramework.Net
{
    public partial class NetworkDiscovery : MonoBehaviour
    {
        ...
        /// 寻找到的响应服务器
        /// </summary>
        public event Action<ServerResponse, IPEndPoint> OnServerResponse;
        ...
        private async void ServerReceive()
        {
            while (udpServer != null)
            {
                try
                {
                    ...
                    var request = reader.Read<ServerRequest>();
        ...
        private void ServerSend(ServerRequest request, IPEndPoint endPoint)
        {
            try
            {
                using var writer = NetworkWriter.Pop();
                writer.WriteLong(version);
                writer.Write(new ServerResponse { uri = NetworkManager.Transport.GetServerUri() });
        ...
        private void ClientSend()
        {
            try
            {
                ...
                using var writer = NetworkWriter.Pop();
                writer.WriteLong(version);
                writer.Write(new ServerRequest());
                var segment = writer.ToArraySegment();
